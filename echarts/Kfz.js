...
var option = {
    ...
    title: [
      //KPIs
      {
        ...
        subtext: 'Elektro',
        top: 0, //header_size * 3,// * result['Elektro'],
        left: '3%',
    ...
    series: [
      {
        ...
        markPoint: {
            animationDelay: 500,
            data: [{ coord: [data['Jahr'].slice(-1).toString(), data['Benzin'].slice(-1)], name: 'Last Symbol' }],
      ...
      },
      {
        ...
        markPoint: {
            animationDelay: 500,
            data: [{ coord: [data['Jahr'].slice(-1).toString(), data['Diesel'].slice(-1)], name: 'Last Symbol' }],
            symbol: 'circle', // Set symbol shape
            symbolSize: 6, // Set symbol size
            label: {
              show: false // Hide label for the last symbol
      ...
      },
      {
        ...
        markPoint: {
            animationDelay: 500,
            data: [{ coord: [data['Jahr'].slice(-1).toString(), data['Elektro'].slice(-1)], name: 'Last Symbol' }],
            symbol: 'circle', // Set symbol shape
            symbolSize: 6, // Set symbol size
            label: {
              show: false // Hide label for the last symbol
      ...
      },
      {
        ...
        markPoint: {
            animationDelay: 500,
            data: [{ coord: [data['Jahr'].slice(-1).toString(), data['Hybrid'].slice(-1)], name: 'Last Symbol' }],
            symbol: 'circle', // Set symbol shape
            symbolSize: 6, // Set symbol size
            label: {
              show: false // Hide label for the last symbol
